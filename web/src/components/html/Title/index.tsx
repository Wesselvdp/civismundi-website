    ...
    <Wrapper className={`world__title__wrapper ${show ? 'show' : 'hide'}`}>
      <div id="world__title" className="world__title">
        <h2>
          ...
          <span className="f-bold">TELLING</span> STORIES,{' '}
          <span className="f-bold">WRITING</span> FILMS, <br />
          <span className="f-bold">DEVELOPING</span> SHOWS,{' '}
          <span className="f-bold">DESIGNING</span> THINGS, <br />
